import PySide6
from PySide6.QtCore import QStringListModel, QSortFilterProxyModel, Qt
from PySide6.QtGui import QStandardItemModel, QStandardItem
from PySide6.QtWidgets import QDialog, QStyledItemDelegate

from dialog import Ui_MainDialog
...
class MainDialog(QDialog, Ui_MainDialog):
    ...
    def __init__(self, parent=None):
        ...
        # QtCore.QMetaObject.connectSlotsByName(RegisterDialog) 会自动链接名字对应的槽函数
        # 所以槽函数不能起对应的名字
        self.setupUi(self)
        self.setup_myui()
    ...
    def setup_myui(self):
        # 禁止改变窗口大小
        self.setWindowFlags(PySide6.QtCore.Qt.WindowType.Dialog | PySide6.QtCore.Qt.WindowType.MSWindowsFixedSizeDialogHint)
        # 显示最小化按钮
        self.setWindowFlag(PySide6.QtCore.Qt.WindowType.WindowMinimizeButtonHint, True)
        self.setWindowTitle("界面")


        sentences = ["I'm + (verb/动词). I’m going now\n我(即将)… 我现在就去",
        ...
        delegate = Delegate(self.listView)
        self.listView.setItemDelegate(delegate)
        self.listView.setModel(self.filter_proxy_model)
